...
public class ClientController {
	...
	public String detailClient(Model model, HttpSession session, @RequestParam("client_id") String client_id) throws Exception {
		UserVO loginVO = (UserVO) session.getAttribute("userVO");
		if (loginVO == null) {
			return "redirect:login.do";
		}
	...
	public String deleteClient(HttpSession session, @RequestParam("client_id") String client_id) throws Exception {
		UserVO loginVO = (UserVO) session.getAttribute("userVO");
		if (loginVO == null) {
			return "redirect:login.do";
		}
